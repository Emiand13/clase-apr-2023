<template>
  <div class="container">
    <caption class="titulo">
      <img
        src="https://www.freepnglogos.com/uploads/oscar-png/oscar-logo-vector-graphics-download-18.png"
        alt="logo-oscars"
        class="logo-oscar"
      />
      IronContacts
      <img
        src="https://www.pngall.com/wp-content/uploads/9/Emmy-Awards-PNG-File.png"
        alt="logo-emmys"
        class="logo-emmy"
      />
    </caption>
    ...
    <div class="botones">
      ...
      <button @click="ordenarPorNombre" class="boton">Sort by Name</button>
      <button @click="ordenarPorPopularidad" class="boton">
        Sort by Popularity
      </button>
    </div>
    ...
    <table>
      <thead>
        <tr>
          <th class="titulos-2">Picture</th>
          <th class="titulos-2">Name</th>
          <th class="titulos-2">Popularity</th>
          <th class="titulos-2">WonOscar</th>
          <th class="titulos-2">WonEmmy</th>
          <th class="titulos-2">Actions</th>
        </tr>
      </thead>
      ...
      <tbody>
        <tr v-for="contact in contacts" :key="contact.name">
          ...
          <td v-html="contact.name" class="names"></td>
          <td v-html="contact.popularity" class="numbers"></td>
          <td class="oscar">
            <span v-if="contact.wonOscar" class="icono-grande">🏆</span>
            <span v-else class="guion">-</span>
          </td>
          <td class="emmy">
            <span v-if="contact.wonEmmy" class="emmy-icono">★</span>
            <span v-else class="guion">-</span>
          </td>
          <td>
            <button
...
const remainingContacts = reactive([
  {
    name: "Matt Damon",
    pictureUrl:
...
const addRandomContact = () => {
  ...
  if (index !== -1) {
    contacts.splice(index, 1);
    // Actualizar la referencia de los contactos
    contacts = [...contacts];
  }
};
...
.fotos {
  ...
  box-shadow: 2px 2px 0px 1px rgba(255, 0, 0, 0.652);
}
...
.container {
  ...
  align-items: center;
  /* justify-content: center; */
  background-image: url("https://i.pinimg.com/originals/27/2c/1e/272c1e9536e74897cb0ff27cef7e6157.jpg");
